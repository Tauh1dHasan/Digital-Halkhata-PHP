...
?>
        ...
        <main class="main">
            ...
            <section class="content">
                <header class="content__title">
                    <h1>Dashboard <small>'Digital Halkhata' is a simple yet powerful tool to keep track of your business accounce.!!</small></h1>
    ...
    <?php  
        $customer_sql = mysqli_query($con, "SELECT * FROM customer WHERE u_id = '$USERID' ");
        $customer_count = mysqli_num_rows($customer_sql);
    ?>
